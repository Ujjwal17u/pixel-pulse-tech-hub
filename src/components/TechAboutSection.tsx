...
const TechAboutSection = () => {
  ...
  return <section id="about" className="py-20 px-4 bg-tech-black">
      <div className="max-w-7xl mx-auto">
        <h2 className="font-primary text-4xl md:text-5xl font-bold text-center mb-16 text-tech-light tech-text-glow animate-fade-in">About YÄ~TSU Squad</h2>
        
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          {/* Left Text Content */}
          <div className="space-y-8 animate-fade-in">
            <p className="text-xl text-tech-gray leading-relaxed font-body">YÄ~TSU Squad is a student-powered community of tech builders and creators. We help our members grow through curated learning, real project experience, community networking, and guided career development.</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {benefits.map((benefit, index) => <div key={index} className="flex items-start gap-4 p-4 bg-tech-dark/50 rounded-lg border border-tech-orange/20 hover:border-tech-orange/50 transition-all duration-300">
